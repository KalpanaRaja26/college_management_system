...
<div class="container">
  <h1>Welcome to Your Faculty Dashboard</h1>
  <div class="nav-links">
    <a href="Notes_form.asp">Upload Notes</a>
    <% If LCase(Session("designation")) = "hod" Then %>
      <a href="Current_sem_form.asp">Current Semester</a>
    <% Else %>
      <a style="background-color: #adb5bd; cursor: not-allowed; pointer-events: none;" title="Only HOD can access">Current Semester</a>
    <% End If %>
  </div>
  
  
  <p>Hello, <%= userEmail %>! You can upload your notes and allocate notes for students here.</p>
</div>
